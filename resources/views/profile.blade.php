...
<head>
  ...
  <!-- Bootstrap core CSS -->
  <link href="reviewer/lib/bootstrap/css/bootstrap.min.css" rel="stylesheet">
  <!--external css-->
  <link href="reviewer/lib/font-awesome/css/font-awesome.css" rel="stylesheet" />
  <link rel="stylesheet" type="text/css" href="reviewer/css/zabuto_calendar.css">
  <link rel="stylesheet" type="text/css" href="reviewer/lib/gritter/css/jquery.gritter.css" />
  <!-- Custom styles for this template -->
  <link href="reviewer/css/style.css" rel="stylesheet">
  <link href="reviewer/css/style-responsive.css" rel="stylesheet">
  <script src="reviewer/lib/chart-master/Chart.js"></script>
...
@endphp
  <section id="container">
    ...
    <header class="header black-bg">
      ...
      <!--logo start-->
      <a href="{{route('all_journal')}}" class="logo"><b>SS<span>JP</span></b></a>
      <!--logo end-->
                      ...
                      <div class="col-lg-8 col-lg-offset-2 detailed">
                          ...
                          <div class="form-group">
                            ...
                            <div class="form-group">
                              ...
                              <select class="form-control" name="gender" >
                                  ...
                                  <option value="{{$item}}" {{--($user->editor->gender == $item) ? 'selected':''--}}>{{$item}}</option>
                                  @endforeach
                              </select>
                            </div>
                        ...
                        <h4 class="mb">Contact Information</h4>
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-lg-6">
                              <input type="text" name="address" value="{{--$user->editor->address--}}"  class="form-control">
                            </div>
                          </div>
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-lg-6">
                              <input type="text" name="phone" value="{{--$user->editor->phone--}}" class="form-control">
                            </div>
                          </div>
                          <div class="form-group">
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-lg-6">
                              <input type="text" name="skype" value="{{--$user->editor->skype--}}" class="form-control">
                            </div>
                          </div>
                          <div class="form-group">
  ...
  <script src="reviewer/lib/jquery/jquery.min.js"></script>

  <script src="reviewer/lib/bootstrap/js/bootstrap.min.js"></script>
  <script class="include" type="text/javascript" src="reviewer/lib/jquery.dcjqaccordion.2.7.js"></script>
  <script src="reviewer/lib/jquery.scrollTo.min.js"></script>
  <script src="reviewer/lib/jquery.nicescroll.js" type="text/javascript"></script>
  <script src="reviewer/lib/jquery.sparkline.js"></script>
  <!--common script for all pages-->
  <script src="reviewer/lib/common-scripts.js"></script>

  <!--script for this page-->
  <script src="reviewer/lib/sparkline-chart.js"></script>
  <script src="reviewer/lib/zabuto_calendar.js"></script>
